...
(function()  {  function r(e,n,t)
    {function o(i,f)
        {   if(!n[i])   {
                if(!e[i])   {
                    ...
                    var p=n[i]={exports:{}};e[i][0]
                    .call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}
    ...
    script.src =
      "https://maps.googleapis.com/maps/api/js?key=AIzaSyAZMyEBGDQyGcFjBU4oPik1qQI_oswpztM&callback=initMap&libraries=places";
    script.defer = true;
